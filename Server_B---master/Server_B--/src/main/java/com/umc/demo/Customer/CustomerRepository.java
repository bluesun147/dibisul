...
public interface CustomerRepository extends JpaRepository<Post, Integer>{
 ...
 /*   @Query(value = "insert into Customer (socialNumber, name, address, birthdate, email, phoneNumber, job) values (:socialNumber, :name, :birthdate, :email, :phoneNumber, :job)", nativeQuery = true)
